...
def kitchen_sink
  ...
  personalization.add_to(SendGridEmail.new(email: 'test2@example.com', name: 'Example User'))
  personalization.add_cc(SendGridEmail.new(email: 'test3@example.com', name: 'Example User'))
  personalization.add_cc(SendGridEmail.new(email: 'test4@example.com', name: 'Example User'))
  personalization.add_bcc(SendGridEmail.new(email: 'test5@example.com', name: 'Example User'))
  personalization.add_bcc(SendGridEmail.new(email: 'test6@example.com', name: 'Example User'))
  ...
  personalization2.add_to(SendGridEmail.new(email: 'test1@example.com', name: 'Example User'))
  personalization2.add_to(SendGridEmail.new(email: 'test2@example.com', name: 'Example User'))
  personalization2.add_cc(SendGridEmail.new(email: 'test3@example.com', name: 'Example User'))
  personalization2.add_cc(SendGridEmail.new(email: 'test4@example.com', name: 'Example User'))
  personalization2.add_bcc(SendGridEmail.new(email: 'test5@example.com', name: 'Example User'))
  personalization2.add_bcc(SendGridEmail.new(email: 'test6@example.com', name: 'Example User'))
