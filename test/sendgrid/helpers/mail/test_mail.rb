...
class TestMail < Minitest::Test
  ...
  def test_hello_world
    from = SendGridEmail.new(email: 'test@example.com')
    to = SendGridEmail.new(email: 'test@example.com')
  ...
  def test_kitchen_sink
    ...
    mail.from = SendGridEmail.new(email: 'test@example.com')
    mail.subject = 'Hello World from the Twilio SendGrid Ruby Library'
    personalization = Personalization.new
    personalization.add_to(SendGridEmail.new(email: 'test1@example.com', name: 'Example User 1'))
    personalization.add_to(SendGridEmail.new(email: 'test2@example.com', name: 'Example User 2'))
    personalization.add_cc(SendGridEmail.new(email: 'test3@example.com', name: 'Example User 3'))
    personalization.add_cc(SendGridEmail.new(email: 'test4@example.com', name: 'Example User 4'))
    personalization.add_bcc(SendGridEmail.new(email: 'test5@example.com', name: 'Example User 5'))
    personalization.add_bcc(SendGridEmail.new(email: 'test6@example.com', name: 'Example User 6'))
    ...
    personalization2.add_to(SendGridEmail.new(email: 'test1@example.com', name: 'Example User 1'))
    personalization2.add_to(SendGridEmail.new(email: 'test2@example.com', name: 'Example User 2'))
    personalization2.add_cc(SendGridEmail.new(email: 'test3@example.com', name: 'Example User 3'))
    personalization2.add_cc(SendGridEmail.new(email: 'test4@example.com', name: 'Example User 4'))
    personalization2.add_bcc(SendGridEmail.new(email: 'test5@example.com', name: 'Example User 5'))
    personalization2.add_bcc(SendGridEmail.new(email: 'test6@example.com', name: 'Example User 6'))
    ...
    mail.reply_to = SendGridEmail.new(email: 'test@example.com')
